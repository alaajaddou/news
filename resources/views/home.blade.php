...
@section('content')
    ...
    <section class="bg-primary text-white py-5 py-md-7 text-center">
        <div class="container py-5">
            ...
            <div class="d-flex flex-wrap justify-content-center gap-3">
                <a href="{{ route('blog.index') }}" class="btn btn-light btn-lg text-secondary shadow-sm">Read Blog</a>
    ...
    <!-- About Section -->
    <section class="py-5 py-md-7 bg-light border-top border-primary">
        <div class="container py-5">
            <div class="row align-items-center justify-content-center text-center">
                ...
                <div class="col-lg-6">
                    ...
                    <a href="{{ route('about') }}" class="btn btn-secondary btn-lg shadow-sm">Learn More About Me</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-5 py-md-7 bg-white border-top border-info">
        <div class="container py-5">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card h-100 shadow-sm transition-hover">
                                ...
                                <div class="card-footer bg-white d-flex justify-content-between align-items-center">
                                    ...
                                    <a href="{{ route('blog.show', $post->slug) }}" class="btn btn-info btn-sm">Read More</a>
                                </div>
                            </div>
                        </div>
                    @endforeach
            ...
            <div class="text-center mt-5">
                <a href="{{ route('blog.index') }}" class="btn btn-success btn-lg shadow-sm">View All Posts</a>
            </div>
        </div>
    </section>

    <!-- Services Section -->
    <section class="py-5 py-md-7 bg-light border-top border-success">
        <div class="container py-5">
            <div class="text-center mb-5">
            ...
            <div class="row g-4">
                @if($featuredServices->count() > 0)
                    @foreach($featuredServices as $service)
                        <div class="col-md-6 col-lg-4">
                            <div class="card h-100 shadow-sm text-center p-4 transition-hover bg-primary bg-opacity-10 border border-primary">
                                @if($service->icon)
                                    <div class="mb-3">
                ...
                @else
                    <div class="col-md-6 col-lg-4">
                        <div class="card h-100 shadow-sm text-center p-4 transition-hover bg-secondary bg-opacity-10 border border-secondary">
                            <div class="mb-3">
                                <i class="fas fa-brain fs-1 text-secondary"></i>
                            </div>
                            <div class="card-body">
                            ...
                            <div class="card-footer bg-transparent border-0">
                                <a href="{{ route('services.index') }}" class="btn btn-secondary">Learn More</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4">
                        <div class="card h-100 shadow-sm text-center p-4 transition-hover bg-info bg-opacity-10 border border-info">
                            <div class="mb-3">
                            ...
                            <div class="card-footer bg-transparent border-0">
                                <a href="{{ route('services.index') }}" class="btn btn-info">Learn More</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4">
                        <div class="card h-100 shadow-sm text-center p-4 transition-hover bg-success bg-opacity-10 border border-success">
                            <div class="mb-3">
                            ...
                            <div class="card-footer bg-transparent border-0">
                                <a href="{{ route('services.index') }}" class="btn btn-success">Learn More</a>
                            </div>
                        </div>
                    </div>
                @endif
            ...
            <div class="text-center mt-5">
                <a href="{{ route('services.index') }}" class="btn btn-warning btn-lg shadow-sm">View All Services</a>
            </div>
        </div>
    </section>

    <!-- CTA Section -->
    <section class="py-5 py-md-7 bg-secondary text-white text-center border-top border-warning">
        <div class="container py-5">
            ...
            <a href="{{ route('contact.index') }}" class="btn btn-warning btn-lg px-5 text-white">Get in Touch</a>
        </div>
    </section>
@endsection
