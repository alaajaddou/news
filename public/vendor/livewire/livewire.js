(() => {
    ...
    'node_modules/nprogress/nprogress.js'(exports, module) {
      (function(root, factory) {
        ...
        NProgress2.set = function(n) {
          ...
          var progress = NProgress2.render(!started2), bar = progress.querySelector(Settings.barSelector),
  ...
  function handleFileUpload(el, property, component, cleanup2) {
    ...
    let start3 = () => el.dispatchEvent(new CustomEvent('livewire-upload-start', {
      bubbles: true,
...
${expression ? 'Expression: "' + expression + '"\n\n' : ''}`, el);
  ...
  function src_default3(Alpine3) {
    ...
    Alpine3.directive('trap', Alpine3.skipDuringClone((el, { expression, modifiers }, {
      effect: effect3,
      evaluateLater: evaluateLater2,
      cleanup: cleanup2
    }) => {
  ...
  function src_default5(Alpine3) {
    Alpine3.directive('intersect', Alpine3.skipDuringClone((el, {
      value,
      expression,
      modifiers
  ...
  function src_default6(Alpine3) {
    Alpine3.directive('resize', Alpine3.skipDuringClone((el, {
      value,
      expression,
      modifiers
    }, { evaluateLater: evaluateLater2, cleanup: cleanup2 }) => {
  ...
  function src_default7(Alpine3) {
    ...
    Alpine3.directive('anchor', Alpine3.skipDuringClone((el, { expression, modifiers, value }, {
      cleanup: cleanup2,
      evaluate: evaluate22
    }) => {
  ...
  function src_default9(Alpine3) {
    Alpine3.directive('mask', (el, { value, expression }, {
      effect: effect3,
      evaluateLater: evaluateLater2,
      cleanup: cleanup2
    }) => {
    ...
    module_default.interceptInit(module_default.skipDuringClone((el) => {
      ...
      directives2.forEach((directive3) => {
        trigger2('directive.global.init', {
          el, directive: directive3, cleanup: (callback) => {
            module_default.onAttributeRemoved(el, directive3.raw, callback);
          }
        });
      });
