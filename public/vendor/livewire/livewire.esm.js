        ...
        var CustomRefImpl = class {
          constructor(factory) {
            ...
            const {
              get: get3,
              set: set3
            } = factory(() => track2(this, 'get', 'value'), () => trigger2(this, 'set', 'value'));
            this._get = get3;
            this._set = set3;
          }
...
var require_module_cjs3 = __commonJS({
  '../alpine/packages/focus/dist/module.cjs.js'(exports, module) {
    ...
    var require_dist = __commonJS2({
      'node_modules/tabbable/dist/index.js'(exports2) {
        ...
        var isZeroArea = function isZeroArea2(node) {
          var _node$getBoundingClie = node.getBoundingClientRect(), width = _node$getBoundingClie.width,
    ...
    function src_default(Alpine23) {
      ...
      Alpine23.directive('trap', Alpine23.skipDuringClone((el, { expression, modifiers }, {
        effect,
        evaluateLater,
        cleanup
      }) => {
...
var require_module_cjs5 = __commonJS({
  '../alpine/packages/intersect/dist/module.cjs.js'(exports, module) {
    ...
    function src_default(Alpine23) {
      Alpine23.directive('intersect', Alpine23.skipDuringClone((el, { value, expression, modifiers }, {
        evaluateLater,
        cleanup
      }) => {
...
var require_module_cjs6 = __commonJS({
  'node_modules/@alpinejs/resize/dist/module.cjs.js'(exports, module) {
    ...
    function src_default(Alpine23) {
      Alpine23.directive('resize', Alpine23.skipDuringClone((el, { value, expression, modifiers }, {
        evaluateLater,
        cleanup
      }) => {
        let evaluator = evaluateLater(expression);
...
var require_module_cjs7 = __commonJS({
  '../alpine/packages/anchor/dist/module.cjs.js'(exports, module) {
    ...
    function src_default(Alpine23) {
      ...
      Alpine23.directive('anchor', Alpine23.skipDuringClone((el, { expression, modifiers, value }, {
        cleanup,
        evaluate: evaluate2
      }) => {
  ...
  'node_modules/nprogress/nprogress.js'(exports, module) {
    (function(root, factory) {
      ...
      NProgress2.set = function(n) {
        ...
        var progress = NProgress2.render(!started), bar = progress.querySelector(Settings.barSelector),
          speed = Settings.speed, ease = Settings.easing;
      ...
      NProgress2.render = function(fromStart) {
        ...
        var bar = progress.querySelector(Settings.barSelector),
          ...
          parent = document.querySelector(Settings.parent), spinner;
        css(bar, {
...
function handleFileUpload(el, property, component, cleanup) {
  ...
  let start2 = () => el.dispatchEvent(new CustomEvent('livewire-upload-start', {
    bubbles: true,
  ...
  let error2 = () => el.dispatchEvent(new CustomEvent('livewire-upload-error', {
    bubbles: true,
    detail: { id: component.id, property }
  }));
  ...
  import_alpinejs5.default.onAttributesAdded((el, attributes) => {
    ...
    attributes.forEach((attribute) => {
      ...
      trigger('directive.init', {
        el, component, directive: directive2, cleanup: (callback) => {
  ...
  import_alpinejs5.default.interceptInit(import_alpinejs5.default.skipDuringClone((el) => {
    ...
    directives.forEach((directive2) => {
      trigger('directive.global.init', {
        el, directive: directive2, cleanup: (callback) => {
          import_alpinejs5.default.onAttributeRemoved(el, directive2.raw, callback);
        }
      });
    });
